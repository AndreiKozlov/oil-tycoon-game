...
**Tilemap-сцена**: рендер сетки 32×32 тайлов через Canvas или CSS grid. Pan + zoom. Тестово 100×100 тайлов (10000) с биомами через Perlin noise. Клик по тайлу → информация в RightPanel.
